inputLines = open('Day4/inputAkku.txt','r')
        ...
        while columnCounter < lengthOfGridWithBoundary - 1:
            ...
            if gridWithBoundary[rowCounter][columnCounter] == "@":
                ...
                if myNeighbours.count("@") < 4:
                    ...
                    accessibleCounter += 1
                    indexesToReplace.append([rowCounter, columnCounter])

            columnCounter += 1

        rowCounter += 1

    print(indexesToReplace)
    print(accessibleCounter)
    totalRemovedCounter += accessibleCounter

    for index1, index2 in indexesToReplace:
        print("Replacing with a dot")
        gridWithBoundary[index1][index2] = "."

    if accessibleCounter == 0:
        break

print(totalRemovedCounter)
